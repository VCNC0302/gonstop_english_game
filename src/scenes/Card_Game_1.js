...
class Card_Game_1 extends Phaser.Scene {
	...
	editorCreate() {
		...
		// rectangle_1
		const rectangle_1 = this.add.rectangle(1120, 126, 600, 100);
		...
		// card_6_2
		const card_6_2 = this.add.image(1651, 716, "_MISSING");

		// card_4_1
		const card_4_1 = this.add.image(1227, 403, "_MISSING");

		// card_1_1
		const card_1_1 = this.add.image(591, 403, "_MISSING");

		// card_2_2
		const card_2_2 = this.add.image(803, 716, "_MISSING");

		// card_5_1
		const card_5_1 = this.add.image(1439, 403, "_MISSING");

		// card_5_2
		const card_5_2 = this.add.image(1439, 716, "_MISSING");

		// card_4_2
		const card_4_2 = this.add.image(1227, 716, "_MISSING");

		// card_6_1
		const card_6_1 = this.add.image(1651, 403, "_MISSING");

		// card_1_2
		const card_1_2 = this.add.image(591, 716, "_MISSING");

		// card_3_2
		const card_3_2 = this.add.image(1015, 716, "_MISSING");

		// card_2_1
		const card_2_1 = this.add.image(803, 403, "_MISSING");

		// card_3_1
		const card_3_1 = this.add.image(1015, 403, "_MISSING");
